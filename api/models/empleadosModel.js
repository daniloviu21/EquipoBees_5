...
class Empleados {
    ...
    static async update(id, data) {
        const { nombre, apellidoP, apellidoM, telefono, correo, fechanac, idDepartamento, idUsuario } = data;
        const result = await pool.query(`UPDATE empleados SET nombre = $1, apellidoP = $2, apellidoM = $3, telefono = $4, correo = $5, fechanac = $6, idDepartamento = $7, idUsuario = $8, updated_at = now() WHERE id = $9 AND deleted_at IS NULL RETURNING *`,[nombre, apellidoP, apellidoM, telefono, correo, fechanac, idDepartamento, idUsuario, id]);
        return result.rows[0];
    }
